...
//        int [ ]CharsinWord=new int[arr.getSize()];
//        double suma=0;
//        for (int i = 0; i < arr.getSize(); i++) {
//            CharsinWord[i]=arr.get(i).length();
//            suma+=arr.get(i).length();
////        }
//        double average=Math.abs(suma/ arr.getSize());
//        double minmalnarazlika=Math.abs(CharsinWord[0]-average);
//        int index=0;
//        for (int i = 1; i < arr.getSize(); i++) {
//            double segasnarazlika=Math.abs(CharsinWord[i]-average);
//            if(segasnarazlika<minmalnarazlika){
//                index=i;
//                minmalnarazlika=segasnarazlika;
//            }
//        }
//
